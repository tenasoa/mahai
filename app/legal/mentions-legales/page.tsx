      ...
      <div className="max-w-4xl mx-auto px-6 py-12 pb-24 relative z-10">
        ...
        <section className="mb-12">
          ...
          <div className="bg-card border border-b1 rounded-lg p-6">
            <div className="space-y-3">
              <div>
                <span className="font-mono text-xs text-text3 uppercase tracking-[0.1em]">Raison sociale</span>
                <p className="text-text mt-1">Mah.AI SAS</p>
              </div>
              <div>
                <span className="font-mono text-xs text-text3 uppercase tracking-[0.1em]">Forme juridique</span>
                <p className="text-text mt-1">Société par actions simplifiée (SAS)</p>
              </div>
              <div>
                <span className="font-mono text-xs text-text3 uppercase tracking-[0.1em]">Capital social</span>
                <p className="text-text mt-1">1 000 000 Ar</p>
              </div>
              <div>
                <span className="font-mono text-xs text-text3 uppercase tracking-[0.1em]">Siège social</span>
              ...
              <div>
                <span className="font-mono text-xs text-text3 uppercase tracking-[0.1em]">Numéro RCS</span>
                <p className="text-text mt-1">À déterminer</p>
              </div>
              <div>
                <span className="font-mono text-xs text-text3 uppercase tracking-[0.1em]">Numéro TVA</span>
                <p className="text-text mt-1">À déterminer</p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-12">
          ...
          <div className="bg-card border border-b1 rounded-lg p-6">
            <div className="space-y-3">
              <div>
                <span className="font-mono text-xs text-text3 uppercase tracking-[0.1em]">Hébergeur</span>
                <p className="text-text mt-1">À déterminer</p>
              </div>
              <div>
                <span className="font-mono text-xs text-text3 uppercase tracking-[0.1em]">Adresse</span>
                <p className="text-text mt-1">À déterminer</p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-12">
          ...
          <div className="bg-card border border-b1 rounded-lg p-6">
            <div className="space-y-3">
              <div>
                <span className="font-mono text-xs text-text3 uppercase tracking-[0.1em]">Email général</span>
                <p className="text-text mt-1 flex items-center gap-2">
              ...
              <div>
                <span className="font-mono text-xs text-text3 uppercase tracking-[0.1em]">Email juridique</span>
                <p className="text-text mt-1 flex items-center gap-2">
                  <Mail className="w-4 h-4 text-gold" />
              ...
              <div>
                <span className="font-mono text-xs text-text3 uppercase tracking-[0.1em]">Téléphone</span>
                <p className="text-text mt-1 flex items-center gap-2">
        ...
        <div className="mt-12 p-6 bg-card border border-b1 rounded-lg text-center">
          ...
          <div className="font-display text-lg text-text2">21 avril 2026</div>
