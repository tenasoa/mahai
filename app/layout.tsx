...
export const metadata: Metadata = {
  ...
  description: 'La plateforme EdTech made in Madagascar. Accède aux sujets BAC, BEPC, CEPE avec des corrections IA et des professeurs certifiés.',
  keywords: ['BAC Madagascar', 'BEPC', 'CEPE', 'examens', 'révisions', 'IA', 'EdTech'],
  openGraph: {
    title: 'Mah.AI — Réussis tes examens avec l\'IA',
    description: 'La plateforme EdTech made in Madagascar. Corrections IA, professeurs certifiés, examens blancs.',
    type: 'website',
    locale: 'fr_MG',
  },
  twitter: {
