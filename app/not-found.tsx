...
export default function NotFound() {
  ...
  const variants = {
    "404": {
      ...
      title: "Cette page n'existe <em>pas encore</em>",
      sub: "Le sujet que vous cherchez a peut-être été déplacé, supprimé ou n'a jamais existé. L'IA a cherché partout — sans succès.",
    },
    "403": {
      code: "403",
      errCode: "ACCESS_FORBIDDEN",
      title: "Accès <em>refusé</em>",
      sub: "Ce contenu est réservé aux abonnés Premium. Rechargez votre solde pour y accéder.",
    },
    "500": {
      code: "500",
      errCode: "SERVER_ERROR",
      title: "Erreur <em>inattendue</em>",
      sub: "Nos serveurs rencontrent un problème temporaire. L'équipe a été notifiée automatiquement.",
    },
    session: {
      code: "⏳",
      errCode: "SESSION_EXPIRED",
      title: "Session <em>expirée</em>",
      sub: "Votre session a expiré pour des raisons de sécurité. Reconnectez-vous pour continuer.",
    },
  };
    ...
    <>
      <style jsx global>{`
        ...
        .four-text::before {
          ...
          opacity: 0.35;
          animation: gb1 6s ease-in-out infinite;
        }
        .four-text::after {
          color: var(--ruby);
          -webkit-text-stroke: 0;
          opacity: 0.2;
          animation: gb2 6s ease-in-out infinite;
        }
        ...
        @keyframes gp {
          ...
          50% {
            box-shadow: 0 0 20px rgba(168, 120, 42, 0.4);
          }
        }
        @keyframes spin {
          to {
      ...
      <div className="relative min-h-screen bg-void transition-colors duration-500">
        <canvas
          ref={canvasRef}
          className="fixed inset-0 z-1 pointer-events-none opacity-35"
        />
        <div
          className="fixed inset-0 z-0 pointer-events-none opacity-[var(--noise-op)]"
          style={{
        ...
        <div className="relative z-[2] flex flex-col items-center justify-center py-20 px-8 text-center min-h-screen">
          <div style={{ position: "relative", marginBottom: "2rem" }}>
            <div className="four-text" data-text={variant.code}>
              <span className={variant.code === "⏳" ? "sand-icon" : ""}>
                {variant.code}
              </span>
            </div>
          </div>
          ...
          >
            <div
              style={{
                ...
                height: "1px",
                background:
                  "linear-gradient(90deg, transparent, var(--gold-line))",
              }}
            />
            <span
              style={{
            ...
            <div
              style={{
                ...
                height: "1px",
                background:
                  "linear-gradient(90deg, var(--gold-line), transparent)",
              }}
            />
          </div>
          ...
          {(["404", "403", "500", "session"] as VariantKey[]).map((k) => (
            <button
              ...
              style={{
                ...
                border: "1px solid var(--b1)",
                background:
                  currentVariant === k ? "var(--gold-dim)" : "var(--surface)",
                color: currentVariant === k ? "var(--gold)" : "var(--text-3)",
                transition: "all 0.2s",
              }}
            >
              {k}
