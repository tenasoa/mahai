...
export default async function AdminSubjectsPage({
  ...
  const { subjects, pagination } = await getSubjectsAdmin(
    statusTab,
    undefined,
    page,
    PAGE_SIZE,
  ...
  if (page > pagination.totalPages && pagination.totalPages > 0) {
    ...
    redirect(
      `/admin/sujets?status=${statusTab}&page=${pagination.totalPages}${qParam}`,
    );
  }
  ...
  const pendingCount =
    (statusTab === "PENDING" ? pagination.total : 0) +
  ...
  return (
    <div className="admin-page-content">
      ...
      <div className="admin-header">
        <div>
          ...
          <p className="admin-subtitle">
            Gérez les examens, modérez les propositions et ajustez les prix
          </p>
        </div>
        {pendingCount > 0 && (
      ...
      <div style={{ marginBottom: "1rem" }}>
        <AdminSearchBar
          placeholder="Rechercher par titre, matière, année, auteur…"
          paramName="q"
        />
      </div>
      ...
      <div className="admin-card">
                      ...
                      >
                        ...
                        <td>
                          ...
                          >
                            ...
                            >
                              {submission.authorPrenom?.charAt(0) || ""}
                              {submission.authorNom?.charAt(0) || ""}
                            </div>
                            <div>
                              <div
                                style={{
                        ...
                        <td style={{ textAlign: "right" }}>
                          <Link
                            href={`/admin/sujets/${submission.id}/review`}
                            className="admin-btn"
                            style={{
                              padding: "0.5rem 1rem",
                              fontSize: "0.75rem",
                    ...
                    <div className="admin-empty-state">
                      ...
                      <div className="admin-empty-state-text">
                        {searchTerm ? (
                          ...
                          <>
                            {statusTab === "ALL" &&
                              "Aucun sujet dans le catalogue"}
                            {statusTab === "PENDING" &&
                              "Aucun sujet en attente de modération"}
                      ...
                      {subject.authorId ? (
                        ...
                        >
                          {subject.authorProfilePicture ? (
                            ...
                            >
                              {subject.authorPrenom?.charAt(0) || ""}
                              {subject.authorNom?.charAt(0) || ""}
                            </div>
                          )}
                          <div>
                            <div
        ...
        <AdminPaginationLinks
          ...
          buildUrl={(p) =>
            `/admin/sujets?status=${statusTab}&page=${p}${qParam}`
          }
        />
      </div>
    </div>
