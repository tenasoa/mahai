...
export default function AdminConfigurationPage() {
  ...
  const handleDeletePhone = async (id: string) => {
    ...
    try {
      const res = await fetch(`/api/admin/merchant-phones?id=${id}`, {
        method: "DELETE",
      });
      if (res.ok) {
  ...
  const handleSavePack = async () => {
    ...
    try {
      ...
      const body = editingPack ? { ...packForm, id: editingPack.id } : packForm;
  ...
  return (
    <div className="admin-page-content">
      <AdminBreadcrumb
        items={[{ label: "Système" }, { label: "Configuration" }]}
      />
          ...
          >
            <div className="modal-header">
              <h3 className="modal-title">
                {editingPhone ? "Modifier le numéro" : "Ajouter un numéro"}
              </h3>
              <button
              ...
              <div className="admin-form-stack">
                ...
                <div className="admin-form-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setPhoneForm({ ...phoneForm, label: e.target.value })
                    }
                ...
                <div className="admin-form-row">
                  ...
                  <label className="admin-checkbox-label">
                    <input
                      ...
                      onChange={(e) =>
                        setPackForm({ ...packForm, isActive: e.target.checked })
                      }
                    />
                    <span>Actif</span>
                  </label>
