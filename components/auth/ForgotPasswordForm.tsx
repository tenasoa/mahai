...
export function ForgotPasswordForm({ onComplete }: ForgotPasswordFormProps) {
  ...
  const goToStep2 = async () => {
    ...
    // For demo, simulate sending OTP and generate a token
    ...
    if (result.error) {
      ...
      setSuccessMessage(result.success || 'Code envoyé avec succès')
      setStep(2)
      setTimerActive(true)
      setTimeout(() => {
      ...
      <div style={{
        ...
        {step === 1 && (
          <div style={{ animation: 'fadeIn 0.3s ease' }}>
            <div style={{ textAlign: 'center', fontSize: '2.2rem', marginBottom: '1rem' }}>📧</div>
            <h1 style={{
