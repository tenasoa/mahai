...
export default function EditorNavbar({
  ...
  return (
    <nav className="editor-navbar" aria-label="Barre d'outils de l'éditeur">
      <Link href="/contributeur" className="editor-nav-logo">
        Mah
        <span className="editor-nav-gem" />
        AI
      </Link>
...
function SaveBadge({
  ...
  const label = lastSavedAt
    ...
    : "● Sauvegardé";
  return (
    <span className="editor-save-badge editor-save-badge--saved">{label}</span>
  );
}
