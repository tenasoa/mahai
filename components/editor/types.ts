...
export const EXAM_TYPES: { value: ExamType; label: string; desc: string }[] = [
  ...
  {
    value: "Etablissement",
    label: "Sujet d'établissement",
    desc: "Examen interne d'un établissement",
  },
...
export const BACC_GENERAL_SERIES = [
  "A1",
  "A2",
  "C",
  "D",
...
export const BACC_TECHNIQUE_SERIES = [
  "STT",
  "STI",
  "STL",
  "STG",
...
export const ANNEES_CONCOURS = Array.from({ length: 31 }, (_, i) =>
  String(2000 + i),
);
...
export const CONTENT_TYPES = [
  { value: "sujet_seul", label: "Sujet seul", desc: "Énoncé uniquement" },
  {
    value: "sujet_corrige",
    label: "Sujet + Corrigé",
    desc: "Avec correction détaillée",
  },
  {
    value: "cours_exercices",
    label: "Cours + Exercices",
    desc: "Support de cours complet",
  },
  {
    value: "annale",
    label: "Annale officielle",
    desc: "Document officiel scanné/retranscrit",
  },
];
...
export const ANNOTATION_TYPES = [
  ...
  {
    value: "theoreme",
    label: "Théorème / Propriété",
    icon: "🔷",
    color: "sage",
    desc: "Propriété mathématique",
  },
  {
    value: "exemple",
    label: "Exemple résolu",
    icon: "✏",
    color: "neutre",
    desc: "Exemple",
  },
  {
    value: "correction",
    label: "Correction (masquée)",
    icon: "✓",
    color: "sage",
    desc: "Révélée après soumission",
  },
];
...
export const STRUCTURE_BLOCS = [
  {
    ...
    icon: "Ⅰ",
    color: "violet",
    desc: "Section principale numérotée",
  },
  {
    value: "exercice",
    label: "Exercice",
    icon: "✎",
    color: "gold",
    desc: "Exercice numéroté avec barème",
  },
  {
    value: "enonce",
    label: "Énoncé",
...
export const MEDIA_BLOCS = [
  {
    value: "formula",
    label: "Formule / Équation",
    icon: "∑",
    desc: "Ouvre la modal KaTeX",
  },
  {
    value: "schema",
    label: "Schéma / Figure",
    icon: "🖼",
    desc: "Placeholder upload image",
  },
...
export function getSeriesForExam(
  examType: ExamType | "",
  baccType?: BaccType | "",
): readonly string[] {
  if (examType === "BACC") {
...
export function deriveNiveau(meta: SubjectMetadata): string {
  ...
  if (meta.examType === "BEPC" || meta.examType === "CEPE")
